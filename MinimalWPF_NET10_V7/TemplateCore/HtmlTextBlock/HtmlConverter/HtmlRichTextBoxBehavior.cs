namespace System.Windows
{
    ...
    public class HtmlRichTextBoxBehavior : DependencyObject
    {
        ...
        public static string GetText(HtmlTextBlock o)
        {
            return ((string)o.GetValue(TextProperty)).Trim();
        }

        public static void SetText(HtmlTextBlock o, string value)
        {
        ...
        {
            var richTextBox = (HtmlTextBlock)dependencyObject;
