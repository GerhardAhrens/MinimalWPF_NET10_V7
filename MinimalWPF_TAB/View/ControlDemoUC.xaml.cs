//-----------------------------------------------------------------------
// <copyright file="ControlDemoUC.cs" company="Lifeprojects.de">
//     Class: ControlDemoUC
...
namespace MinimalWPF.View
{
    ...
    /// <summary>
    /// Interaktionslogik für ControlDemoUC.xaml
    /// </summary>
    public partial class ControlDemoUC : UserControlBase
    {
        public ControlDemoUC(ChangeViewEventArgs args) : base(typeof(ControlDemoUC))
