...
namespace System.Data
{
    ...
    public static class DataTableExtensions
    {
        ...
        /// <summary>
        /// Remove doublicate entry in DataTable
        /// </summary>
        ...
        /// <summary>
        /// Die Extension erstellt aus zwei DataTable eine neue DataTable mit den Feldern der beiden Tabellen.
        /// </summary>
        /// <param name="this">DataTable</param>
        /// <param name="t2">DataTable</param>
        /// <param name="joinOn">Kriterien der Parameter um beide Tabellen zu verbinden</param>
        /// <returns>DataTable</returns>
        /// <remarks>
        /// Die beiden Felder für den Join-Vergleich müssen den gleichen Namen und Typ haben
        /// </remarks>
        /// <example>
        /// var test = contact.JoinDataTables(Anrede,
        ///                                   (row1, row2) => 
        ///                                   row1.Field<int>("AnredeId") == row2.Field<int>("AnredeId"));
        /// </example>
        public static DataTable JoinDataTables(this DataTable @this, DataTable t2, params Func<DataRow, DataRow, bool>[] joinOn)
        {
            ...
            foreach (DataRow row1 in @this.Rows)
            {
                ...
                foreach (DataRow fromRow in joinRows)
                {
                    ...
                    foreach (DataColumn col1 in @this.Columns)
                    {
